...
NOTE: This was forked from the very detailed [original repo from William Lam](https://github.com/lamw/vcf-9x-in-box). Please consult the [CHANGELOG](CHANGELOG.md) for any delta differences. I intend to iterate on his work here with my own changes over time, mostly infrastructure automation and scripting.
...
- [VMware Cloud Foundation (VCF) 9.x in a Box](#vmware-cloud-foundation-vcf-9x-in-a-box)
