...
VCF_INSTALLER_OVA="/Users/bryansullins/Downloads/VCFInstaller901/VCF-SDDC-Manager-Appliance-9.0.1.0.24962180.ova"
...
VCF_INSTALLER_HOSTNAME=sddcm01.chekhovspun.lab
VCF_INSTALLER_IP=172.30.0.12
VCF_INSTALLER_SUBNET=255.255.255.0
VCF_INSTALLER_GATEWAY=172.30.0.1
VCF_INSTALLER_DNS_SERVER=172.30.0.5,172.30.0.6
VCF_INSTALLER_DNS_DOMAIN=chekhovspun.lab
VCF_INSTALLER_DNS_SEARCH=chekhovspun.lab
VCF_INSTALLER_NTP=0.pool.ntp.org,1.pool.ntp.org
